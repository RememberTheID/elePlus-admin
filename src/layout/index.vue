<template>
  <div class="flex h-full">
    <ElSplitter>
      <ElSplitterPanel :min="60" :size="width">
        <Menu />
      </ElSplitterPanel>
      <ElSplitterPanel :min="700">
            ...
            <div class="flex flex-col">
              <div class="mr-2 flex items-center justify-between">
                <div class="flex">
                  ...
                  <Icon icon="material-symbols:keyboard-double-arrow-right-rounded" v-else
                    class="text-2xl cursor-pointer" @click="switchCollapse()" />
...
import { ElConfigProvider, ElSplitter, ElSplitterPanel } from 'element-plus'
...
const width = ref(menuStore.isCollapse ? 60 : 200)
watch(
  () => menuStore.isCollapse,
  () => {
    width.value = menuStore.isCollapse ? 60 : 200
  }, {
  immediate: true
}
)
